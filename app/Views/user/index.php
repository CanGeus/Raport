        ...
        <div class="col-lg-12">
            <div class="card border-left-dark shadow h-100 py-2">
                <?php foreach ($login as $l) : ?>
                    <marquee style="font-size: larger;" behavior="" direction="left">Selamat datang, <?= $l['nama']; ?> di Aplikas E-Rapot </marquee>
                <?php endforeach; ?>
            </div>
        </div>
    </div>
                    ...
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img height="300" src="<?= base_url(); ?>/img/carousel/1.jpg" class="d-block w-100">
                            ...
                            <div class="carousel-item">
                                <img height="300" src="<?= base_url(); ?>/img/carousel/2.jpg" class="d-block w-100">
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 class="text-uppercase">penampilan kesenian siswa</h5>
                                    <p>siswa melakukan seni keterampilan</p>
                                </div>
                            ...
                            <div class="carousel-item">
                                <img height="300" src="<?= base_url(); ?>/img/carousel/3.jpg" class="d-block w-100">
                                <div class="carousel-caption d-none d-md-block">
