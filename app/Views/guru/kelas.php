    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php foreach ($guru as $g) : ?>
                            <div class="col-3">
                                <img style="border-radius: 7px;" width="125" src="<?= base_url(); ?>/img/<?= $g['img']; ?>" alt="">
                            </div>
                            <div class="col-sm-9">
                                <div class="card">
                                    <div class="card-body">
                ...
                <div class="card-body">
                    <div class="row">
                        <?php foreach ($ketua as $k) : ?>
                            <div class="col-3">
                                <img style="border-radius: 7px;" width="125" src="<?= base_url(); ?>/img/<?= $k['img']; ?>" alt="">
                            </div>
                            <div class="col-sm-9">
                                <div class="card">
                                    <div class="card-body">
        ...
        <div class="col-xl-5 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase">data siswa kelas 1</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="">
